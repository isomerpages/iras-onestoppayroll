...
<ul data-tight="true" class="tight">
<li>
<p>Contact the PGI Team to authorize your Organization to the Sandbox APIs.</p>
</li>
</ul>
...
<p>Log into API Developer Portal, ensure that your OAuth 2.1 profile is set
up with the necessary JWKS endpoint, and that your API key is set up. Check
that your Organization is subscribed to the OAuth2.1 protected Production
APIs.</p>
</li>
<li>
...
<ul data-tight="true" class="tight">
<li>
<p>Contact the PGI Team to authorize your Organization to the Production
APIs.</p>
</li>
</ul>
<p>
